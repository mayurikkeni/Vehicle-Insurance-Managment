...
//purchase//
// @GetMapping("purchase")
// public String purchasePolicy(Model model) {

// model.addAttribute("purchase", insuranceService.getAllInsurance());
// System.out.println();
// return "purchase";
/*
 * @GetMapping("myProfile/{userId}") public String showUpdateForm(@PathVariable
 * ("userId") Long userId, Model model) { model.addAttribute("myProfile",
 * vehicleService.findVehicleByUserId( userId)); return "myProfile";
 */
